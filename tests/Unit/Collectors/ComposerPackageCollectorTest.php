...
class ComposerPackageCollectorTest extends TestCase
{
    private ReflectionMethod $method;

    protected function setUp(): void
    {
        $this->method = new ReflectionMethod(ComposerPackageCollector::class, 'resolveUpdateType');
        $this->method->setAccessible(true);
    }

    private function resolve(string $current, string $latest): string
    {
        return $this->method->invoke(new ComposerPackageCollector, $current, $latest);
    }
